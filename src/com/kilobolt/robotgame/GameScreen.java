...
public class GameScreen extends Screen {
	...
	private Animation anim, anim2, hanim;
	...
	public GameScreen(Game game) {
		...
		//Handle walk
		anim = new Animation();
		anim.addFrame(Assets.characterBeginWalk, 120);
		anim.addFrame(Assets.characterWalk, 120);
		
		//Handle blink
		anim2 = new Animation();
		anim2.addFrame(Assets.characterIdle, 1250);
		anim2.addFrame(Assets.characterIdleBlink, 100);
	...
	private void drawReadyUI() {
		...
		g.drawString("Toque para iniciar.", 400, 240, paint);
	...
	private void drawGameOverUI() {
		...
		g.drawString("Toque para retornar.", 400, 290, paint);
