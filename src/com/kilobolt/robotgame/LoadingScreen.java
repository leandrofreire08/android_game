...
public class LoadingScreen extends Screen {
	...
	public void update(float deltaTime) {
		...
		Assets.characterJump = g.newImage("character_idle.png", ImageFormat.ARGB4444);
		Assets.characterDown = g.newImage("character_down.png", ImageFormat.ARGB4444);
		
		Assets.characterBeginWalk = g.newImage("character_begin_walk.png", ImageFormat.ARGB4444);
		Assets.characterIdle = g.newImage("character_idle.png", ImageFormat.ARGB4444);
		Assets.characterIdleBlink = g.newImage("character_idle_blink.png", ImageFormat.ARGB4444);
		Assets.characterWalk = g.newImage("character_walk_end.png", ImageFormat.ARGB4444);
		Assets.characterFall = g.newImage("character_fall.png", ImageFormat.ARGB4444);
